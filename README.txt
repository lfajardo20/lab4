...
-After deploying on tomcat on 8080, go to the build.properties and change the tomcat_home to to port 8081 and deploy again. This is to have both tomcats have the file.
-Test your endpoints to send messages to the producer.
****NOTE: In order to use the consumer, only the windows command line works for now****
